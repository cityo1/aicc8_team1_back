...
router.get('/', async (req, res) => {
  try {
    const defaultUrl =
      'https://docs.google.com/spreadsheets/d/e/2PACX-1vQVx5HCfmel_V5xZzwtoOko5zRWReD5QsoZ2d4HAL1i2jivdjt5ueja5QeVT5z_U44HcJLhF21tYwnc/pub?output=csv'; // 임시 값이지만 추후 전체 URL로 교체하세요.
